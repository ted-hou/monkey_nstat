...
HistCollObj = HistoryObj.computeHistory(NstCollObj);
CovCollObj.addCovCollection(HistCollObj);
...
clear iCell spikeTimes Mocap time iTrial eTimes eLabels numCells
